        ...
        sections: [
          {
            title: '𝐃𝐀𝐑𝐊_𝐌𝐃',
            rows: [
              { title: 'Download Menu 📥', description: '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 𝐃𝐀𝐑𝐊 𝐌𝙳', id: `${prefix}category download` },
              { title: 'Owner Menu ⭕', description: '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 𝐃𝐀𝐑𝐊 𝐌𝙳', id: `${prefix}category owner` },
              { title: 'Group Menu 👥', description: '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 𝐃𝐀𝐑𝐊 𝐌𝙳', id: `${prefix}category group` },
              { title: 'Other Menu 🔻', description: '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 𝐃𝐀𝐑𝐊 𝐌𝙳', id: `${prefix}category other` },
              { title: 'Search Menu 🔎', description: '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 𝐃𝐀𝐑𝐊 𝐌𝙳', id: `${prefix}category search` },
              { title: 'Convert Menu 🔄', description: '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 𝐃𝐀𝐑𝐊 𝐌𝙳', id: `${prefix}category convert` },
              { title: 'Main Menu �', description: '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 𝐃𝐀𝐑𝐊 𝐌𝙳', id: `${prefix}category main` },
              { title: 'Bug Menu 🔴', description: '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 𝐃𝐀𝐑𝐊 𝐌𝙳', id: `${prefix}category bug` },
              { title: 'Movie Menu 🎥', description: '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 𝐃𝐀𝐑𝐊 𝐌𝙳', id: `${prefix}category movie` },
              { title: 'AI Menu 🤖', description: '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 𝐃𝐀𝐑𝐊 𝐌𝙳', id: `${prefix}category ai` },
              { title: 'Wallpapers Menu 🌁', description: '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 𝐃𝐀𝐑𝐊 𝐌𝙳', id: `${prefix}category wallpapers` },
              { title: 'Education Menu 🖊️', description: '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 𝐃𝐀𝐑𝐊 𝐌𝙳', id: `${prefix}category education` },
              { title: 'News Menu 🌐', description: '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 𝐃𝐀𝐑𝐊 𝐌𝙳', id: `${prefix}category news` },
              { title: 'NFSW Menu 🤤', description: '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 𝐃𝐀𝐑𝐊 𝐌𝙳', id: `${prefix}category nfsw` }
            ]
          }
        ]
      };
...
`;
    ...
    await conn.sendMessage(from, {
      image: { url: "https://i.ibb.co/RpsTKK8N/SulaMd.jpg" },
      caption: text + `\n\n${footerText}`
    }, { quoted: m });
